...
本 Fork 的 [`remote-manifest.json`](remote-manifest.json) 精选了 30 张 ChineseBQB 混合分类表情，其中包含 13 张 GIF，并把素材 URL 固定到已校验的上游提交。图片仍由独立第三方项目 ChineseBQB 托管，不受 Codex Meme 的 MIT License 覆盖。
